...
INSERT INTO participant (id, username, password, age, gender, ethnicity, disability,education,mobileHandlingExperience,psycothereputicMedications,colorblind,targetGroupId) values (1, 'parasar', 'parasar', 26, 'male', 'Asian', 'true', 'graduate', 'average', 'none', 'true' ,1);
